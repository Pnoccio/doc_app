<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <textarea class="mt-1 block w-full border-gray-300 focus:border-indingo-300 focus:ring-indingo-200 focus:ring-opacity-50 roundend-md shadow-sm" id="bio" wire:model.defer="state.bio_data" placehoder="Bio Data"></textarea>
